odoo.define('show_sequence_columns_easy_ma_mi_la_ti_12_12.my_list_view', function (require) {
"use strict";
    ...
    View.include({
        ...
        render_fields_show: function () {
            ...
            if (this.fields_view.type == 'tree' && typeof(this.result) != 'undefined'){
                ...
                QWeb.add_template("/show_sequence_columns_easy_ma_mi_la_ti_12_12/static/src/xml/my_control.xml");
